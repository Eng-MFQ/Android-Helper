...
public class StringHelper {
        ...
        try {
            ...
            while ((val = readStreamUTF8(is)) != -1) {
                ...
                if (val <= 0xFFFF) {
                    ...
                    int high4 = ((val >> 16) & 0x1F) - 1;
                    int mid6 = ((val >> 10) & 0x3F);
                    int low10 = val & 0x3FF;
    ...
    private final static int readStreamUTF8(InputStream is) {
        int c = -1;
        if (is == null)
            return c;
        ...
        try {
            ...
            while (!complete && (byteVal = is.read()) != -1) {
                if (expecting > 0 && (byteVal & 0xC0) == 0x80) {
                    expecting--;
